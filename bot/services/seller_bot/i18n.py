...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "client_found": "✅ Найден клиент: {name} ({phone}).",
        ...
        "tier_amount_too_small": "Сумма пока меньше 1 000 000 сум — баллы начислятся, когда сумма продажи достигнет минимум 1 000 000 сум.",
        "tier_amount_too_small_button": "⚠️ Сумма мала для баллов",
    ...
    "uz": {
        ...
        "client_found": "✅ Topildi: {name} ({phone}).",
        ...
        "tier_amount_too_small": "Summa hali 1 000 000 so'mdan kam — sotuv summasi kamida 1 000 000 so'mga yetganda ball beriladi.",
        "tier_amount_too_small_button": "⚠️ Summa ball uchun kam",
    ...
    "tr": {
        ...
        "client_found": "✅ Bulundu: {name} ({phone}).",
        ...
        "tier_amount_too_small": "Tutar henüz 1 000 000 sum'un altında — satış tutarı en az 1 000 000 sum olduğunda puan verilir.",
        "tier_amount_too_small_button": "⚠️ Tutar puan için az",
