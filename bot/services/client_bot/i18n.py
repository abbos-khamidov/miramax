...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "menu_prizes": "🎁 Призы",
        "open_catalog_text": "Откройте каталог призов по кнопке ниже:",
        "open_catalog_button": "🎁 Открыть каталог",
        "menu_history": "🧾 История обменов",
        "menu_call_store": "📞 Позвонить в магазин",
        "menu_language": "🌐 Язык",
        "call_store_text": "Звоните нам: {phone}",
        "call_store_text_named": "Ваш магазин — {store_name}.\nЗвоните: {phone}",
    ...
    "uz": {
        ...
        "open_catalog_text": "Sovg'alar katalogini quyidagi tugma orqali oching:",
        "open_catalog_button": "🎁 Katalogni ochish",
        "menu_history": "🧾 Almashtirish tarixi",
        "menu_call_store": "📞 Do'konga qo'ng'iroq",
        "menu_language": "🌐 Til",
        "call_store_text": "Bizga qo'ng'iroq qiling: {phone}",
        "call_store_text_named": "Sizning do'koningiz — {store_name}.\nQo'ng'iroq qiling: {phone}",
    ...
    "tr": {
        ...
        "menu_prizes": "🎁 Ödüller",
        "open_catalog_text": "Ödüller kataloğunu aşağıdaki butondan açın:",
        "open_catalog_button": "🎁 Kataloğu aç",
        "menu_history": "🧾 Takas geçmişi",
        "menu_call_store": "📞 Mağazayı ara",
        "menu_language": "🌐 Dil",
        "call_store_text": "Bizi arayın: {phone}",
        "call_store_text_named": "Mağazanız — {store_name}.\nArayın: {phone}",
