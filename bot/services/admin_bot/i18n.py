...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "menu_open_panel": "🖥 Открыть панель",
        "open_panel_prompt": "Нажмите кнопку ниже, чтобы открыть панель Завода:",
        ...
        "submenu_admin": "👤 Админ",
        "submenu_supplier": "🚚 Поставщик",
        "submenu_wholesaler": "📦 Оптовик",
    ...
    "uz": {
        ...
        "menu_open_panel": "🖥 Panelni ochish",
        "open_panel_prompt": "Zavod panelini ochish uchun quyidagi tugmani bosing:",
        "menu_analytics": "📊 Analitikani ochish",
        "menu_points_rate": "💱 Ball kursi",
        "menu_add_product": "➕ Tovar qo'shish",
        "menu_language": "🌐 Til",
        ...
        "submenu_admin": "👤 Admin",
        "submenu_supplier": "🚚 Yetkazib beruvchi",
        "submenu_wholesaler": "📦 Optovik",
    ...
    "tr": {
        ...
        "menu_open_panel": "🖥 Paneli aç",
        "open_panel_prompt": "Fabrika panelini açmak için aşağıdaki düğmeye basın:",
        ...
        "submenu_admin": "👤 Admin",
        "submenu_supplier": "🚚 Tedarikçi",
        "submenu_wholesaler": "📦 Toptancı",
        "submenu_back": "⬅️ Geri",
