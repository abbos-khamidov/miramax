...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "online_showcase_pending": "🛍 Онлайн-витрина формируется и скоро будет готова.",
        "analytics_link_text": "Открыть панель аналитики:",
        "analytics_open_button": "📊 Открыть аналитику",
        "menu_language": "🌐 Язык",
        "points_rate_current": "Сейчас: {sum_per_point} сум = 1 балл.\nВведите новое значение — сколько сум за 1 балл:",
        "points_rate_change_value": "✏️ Изменить значение",
        ...
        "set_tier_saved": "Готово: кнопка {tier} сум активна. Баллы считаются по общему курсу (см. «Курс баллов»), не по этому числу.",
        "show_tiers_empty": "Номиналы ещё не настроены.",
        "show_tiers_rate": "Курс: {sum_per_point} сум = 1 балл.",
    ...
    "uz": {
        ...
        "online_showcase_pending": "🛍 Onlayn vitrina tayyorlanmoqda, tez orada tayyor bo'ladi.",
        "analytics_link_text": "Analitika panelini oching:",
        "analytics_open_button": "📊 Analitikani ochish",
        "menu_language": "🌐 Til",
        "points_rate_current": "Hozir: {sum_per_point} so'm = 1 ball.\nYangi qiymatni kiriting — 1 ball uchun necha so'm:",
        "points_rate_change_value": "✏️ Qiymatni o'zgartirish",
        ...
        "set_tier_saved": "Tayyor: {tier} so'm tugmasi faol. Ballar shu songa emas, umumiy kursga («Ball kursi») qarab hisoblanadi.",
        "show_tiers_empty": "Nominallar hali sozlanmagan.",
        "show_tiers_rate": "Kurs: {sum_per_point} so'm = 1 ball.",
    ...
    "tr": {
        ...
        "online_showcase_pending": "🛍 Online vitrin hazırlanıyor, yakında hazır olacak.",
        "analytics_link_text": "Analiz panelini açın:",
        "analytics_open_button": "📊 Analizi aç",
        "menu_language": "🌐 Dil",
        "points_rate_current": "Şu an: {sum_per_point} so'm = 1 puan.\nYeni değeri girin — 1 puan için kaç so'm:",
        "points_rate_change_value": "✏️ Değeri değiştir",
        ...
        "set_tier_saved": "Tamam: {tier} sum düğmesi aktif. Puanlar bu sayıya değil, genel kura («Puan kuru») göre hesaplanır.",
        "show_tiers_empty": "Tutarlar henüz ayarlanmadı.",
        "show_tiers_rate": "Kur: {sum_per_point} sum = 1 puan.",
